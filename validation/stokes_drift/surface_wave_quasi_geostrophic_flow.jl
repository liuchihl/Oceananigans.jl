...
record(fig, "surface_wave_quasi_geostrophic_induced_flow.mp4", 1:Nt, framerate=8) do nn end
record(fig, "surface_wave_non_rotating_induced_flow.mp4", 1:Nt, framerate=8) do nn end
    n[] = nn
